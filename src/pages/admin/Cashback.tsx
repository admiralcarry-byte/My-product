...
const Cashback = () => {
  ...
  // Mock cashback settings
  const [cashbackSettings, setCashbackSettings] = useState({
    baseCashbackRate: 5.0, // percentage per liter
    tierBenefits: {
      Lead: {
        multiplier: 1.0,
        minPurchase: 0,
  ...
  const totalUsers = tierStats.reduce((sum, stat) => sum + stat.users, 0);
  const totalCashback = tierStats.reduce((sum, stat) => sum + stat.totalCashback, 0);
  const avgGrowthRate = tierStats.reduce((sum, stat) => sum + stat.growthRate, 0) / tierStats.length;
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold">Cashback Settings</h1>
          <p className="text-muted-foreground">Configure loyalty tiers and cashback rewards</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card className="bg-gradient-to-br from-white to-success/10 border-0 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-200">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-success">${totalCashback.toLocaleString()}</div>
            <div className="flex items-center text-xs text-success font-medium">
        ...
        <Card className="bg-gradient-to-br from-white to-accent/10 border-0 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-200">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-accent">{cashbackSettings.baseCashbackRate}%</div>
            <div className="flex items-center text-xs text-success font-medium">
        ...
        <Card className="bg-gradient-to-br from-white to-water-light/20 border-0 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-200">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-water-blue">+{avgGrowthRate.toFixed(1)}%</div>
            <div className="flex items-center text-xs text-success font-medium">
